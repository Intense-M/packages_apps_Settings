...
public class DeviceInfoSettings extends SettingsPreferenceFragment implements Indexable {
    ...
    private static final String KEY_INTENSE_BUILD_DATE = "build_date";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setValueSummary(KEY_INTENSE_VERSION, "ro.intense.version");
        setValueSummary(KEY_INTENSE_BUILD_DATE, "ro.build.date");
